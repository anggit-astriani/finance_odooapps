...
class HrPayslip(models.Model):
    ...
    # states={'draft': [('readonly', False)]} compute='_compute_employee_readonly'
    ...
    # @api.depends('state')
    # def _compute_employee_readonly(self):
    #     for rec in self:
    #         if rec.state == 'draft':
    #             rec.employee_id.readonly = False
    #         else:
    #             rec.employee_id.readonly = True
